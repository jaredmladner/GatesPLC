...
namespace GateAccessAPI
{
    ...
    public class Driver
    {
        ...
        /// </summary>
        public static List<string> ModbusTcpMasterReadInputs(ushort startAddress, ushort numInputs)
        {
            List<string> returnVals = new List<string>();
            using (TcpClient client = new TcpClient("10.200.10.2", 502))
            {
                ...
                for (int i = 0; i < numInputs; i++)
                {
                    ...
                    returnVals.Add($"Register {(startAddress + i)}={(inputs[i])}");
                }
            }
            return returnVals;
            // output: 
        ...
        public static void ModbusUdpMasterWriteCoils()
        {
            ...
            {
                IPEndPoint endPoint = new IPEndPoint(new IPAddress(new byte[] { 10, 200, 10, 2 }), 502);
        ...
        public static void StartModbusTcpSlave()
        {
            byte slaveId = 1;
            int port = 502;
            IPAddress address = new IPAddress(new byte[] { 10, 200, 10, 2 });
        ...
        /// </summary>
        public static List<string> ModbusTcpMasterReadInputsFromModbusSlave(ushort startAddress, ushort numInputs)
        {
            List<string> returnVals = new List<string>();
            byte slaveId = 1;
            int port = 502;
